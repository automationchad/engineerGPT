...
import { SlidersVertical, TriangleAlert, Sparkles } from "lucide-react";
...
interface MessageSettingsProps {
  ...
  onExecute: () => void; // Add this prop
  disabled: boolean;
}

const GroupAnswerSettings: React.FC<MessageSettingsProps> = ({ onSettingsChange, onExecute, disabled }) => {
        ...
        <div className="space-y-4">
          ...
          <div className="mt-2">
            <Input
              ...
              className={`w-full resize-none ${
                !settings.context ? "border-red-500 ring-red-500 text-red-500 placeholder:text-red-300" : ""
              }`}
              required
            />
          </div>
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            <Button
              ...
              disabled={disabled || !settings.context}>
              Execute
            </Button>
          </div>
        </div>
...
export default GroupAnswerSettings;
